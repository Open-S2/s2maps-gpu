...
export default function drawWallpaper (painter: Painter, wallpaper: Wallpaper) {
  ...
  if (uniforms) {
    ...
    gl.uniform4fv(wallpaperProgram.backgroundColor, uniforms.backgroundColor)
    gl.uniform4fv(wallpaperProgram.fade1Color, uniforms.fade1Color)
    gl.uniform4fv(wallpaperProgram.fade2Color, uniforms.fade2Color)
    gl.uniform4fv(wallpaperProgram.haloColor, uniforms.haloColor)
  }
