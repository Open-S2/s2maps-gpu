...
export default function simplify (coords: Array<number>, first: number, last: number,
  sqTolerance: number) {
...
function getSqSegDist (ps: number, pt: number, s: number, t: number,
  bs: number, bt: number): number {
  let ds = bs - s
  let dt = bt - t
