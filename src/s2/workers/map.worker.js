...
class MapWorker {
  ...
  onMessage ({ data }) {
    ...
    if (type === 'vectordata') this.map.injectVectorSourceData(data.source, data.tileID, data.parentLayers, data.vertexBuffer, data.indexBuffer, data.codeTypeBuffer, data.featureGuideBuffer)
