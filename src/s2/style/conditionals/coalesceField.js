...
export default function coalesceField (field: string | Array<string>,
  properties: Object, fieldIsKey: boolean = false): string {
...
function coalesceText (field: string, properties: Object, fieldIsKey: boolean): string {
  if (field[0] === '?') {
    ...
    return ''
  } else { return fieldIsKey ? properties[field] : field }
}
