/** TYPES */
import type { Face, Properties, VectorGeometryType } from 'gis-tools';
...
export type FeatureVector =
  | FeatureVectorPoint
  | FeatureVectorMultiPoint
  | FeatureVectorLineString
  | FeatureVectorMultiLineString
  | FeatureVectorPolygon
  | FeatureVectorMultiPolygon;
