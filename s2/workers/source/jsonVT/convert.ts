 ...
 * @param jsonVT
 */
export default function convert(data: JSONCollection, jsonVT: JsonVT): FeatureVector[] {
...
function convertFeature(
  ...
  if (geometry.length > 0) {
    features.push(createFeature(type, geometry, json.properties, 'face' in json ? json.face : 0));
  }
}
