 ...
 *
 */
type Sections = [FeatureVector[], FeatureVector[], FeatureVector[], FeatureVector[]];
 ...
 * @param axis
 */
function clipPoints(geom: number[], newGeom: number[], k1: number, k2: number, axis: 0 | 1): void {
