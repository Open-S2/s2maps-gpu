...
@binding(1) @group(0) var<uniform> colorUniforms : ColorUniforms;
...
vec4 cBlindAdjust (in vec4 rgba) {
  ...
  float CVD[9];
  if (colorUniforms.uCBlind == 1.) CVD = float[9](0.0, 2.02344, -2.52581, 0., 1., 0., 0., 0., 1.); // protanopia
  else if (colorUniforms.uCBlind == 2.) CVD = float[9](1.0, 0., 0., 0.494207, 0., 1.24827, 0., 0., 1.); // deutranopia
