---
title: 'Display a Map'
description: 'Initialize an S2 Maps GPU Object.'
...
<html>
  ...
  <script src="https://opens2.com/s2maps-gpu/{{VERSION}}/s2maps-gpu.min.js"></script>
  <link rel="stylesheet" href="https://opens2.com/s2maps-gpu/{{VERSION}}/s2maps-gpu.min.css">
  <style>
  ...
  <script>
    ...
    const style = { ... }
    // 🗺️ create the map
    new S2Map({ style, apiKey, container })
  </script>
...
import S2MapsGPU from 's2maps-gpu-react'
import { style } from './style'

export default function App () {
  return (
    <div className='App'>
      <S2MapsGPU style={style} />
    </div>
  )
}
```
...
export const style: StyleDefinition = {
  version: 1,
  ...
  maxzoom: 18.99,
  sources: {
    streets: 'https://api.s2maps.com/s2tiles/s2maps/streets-v1.s2tiles',
    terrain: 'https://api.s2maps.com/s2tiles/s2maps/terrain-v1.s2tiles'
  },
  fonts: {
    robotoRegular: 'https://api.s2maps.com/glyphs-v2/RobotoRegular',
    robotoMedium: 'https://api.s2maps.com/glyphs-v2/RobotoMedium',
    notoRegular: 'https://api.s2maps.com/glyphs-v2/NotoRegular',
    notoMedium: 'https://api.s2maps.com/glyphs-v2/NotoMedium'
  },
  wallpaper: {
    background: '#030a2d',
