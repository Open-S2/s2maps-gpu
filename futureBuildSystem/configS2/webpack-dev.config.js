...
var conifguration = {
    ...
    output: {
        path: path_1.default.join(_dirname, '../buildS2-dev'),
        publicPath: "https://s2maps.dev/s2maps-gpu/v".concat(version, "/"),
    ...
    plugins: [
        ...
        new webpack_1.default.BannerPlugin("s2maps-gpu is Copyright \u00A9 ".concat((new Date()).getFullYear(), " OpenS2 and subject to the S2 Maps Terms of Service (https://www.opens2.com/tos/).")),
