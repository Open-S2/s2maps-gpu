...
const style: StyleDefinition = {
  version: 1,
  name: 's2 range example',
  center: [-122.42, 37.778443127730476],
  zoom: 7,
  minzoom: -0.5,
  maxzoom: 18.99,
  sources: {
    ...
    tesla: '/s2json/tesla-locations.s2json'
  },
  fonts: {
  ...
  icons: {
    teslaIcons: 'apiURL://glyphs/tesla'
  },
  wallpaper: {
    background: '#030a2d',
  ...
  layers: [
    {
      ...
      color: {
        inputRange: {
          ...
          ranges: [
            { stop: 0, input: '#f9f7e7' },
            { stop: 2.75, input: '#eeebe2' },
            { stop: 7.5, input: '#efeeed' },
    ...
    },
    {
      ...
      filter: {
        and: [
          {
            or: [
              { key: 'layer', comparator: '==', value: null },
          ...
          conditions: [
            {
              filter: {
                and: [
                  { key: 'charger', comparator: '==', value: true },
                  { key: 'store', comparator: '!=', value: true },
                  { key: 'service', comparator: '!=', value: true },
                  { key: 'superCharger', comparator: '!=', value: true }
                ]
              },
              input: '#666666'
            },
            ...
            {
              filter: { key: 'store', comparator: '==', value: true },
              input: '#cc0202'
            }
          ],
          fallback: 'rgba(0, 0, 0, 0)'
