      ...
      <main className={styles.main}>
        <div className={styles.Home}>
          ...
          <div className={styles.banner}>
            <Image src='/images/home/S2Logo.svg' width={500} height={182} id={styles.s2Logo} alt='jolly-roger' />
          </div>
          ...
          <div className={styles.navigationContainer}>
            ...
            <Link href='/streets' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='streets' src='/images/home/streets.png' />
            ...
            <Link href='/dark' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='dark' src='/images/home/dark.png' />
            ...
            <Link href='/light' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='light' src='/images/home/light.png' />
            ...
            <Link href='/outdoor' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='outdoor' src='/images/home/outdoor.png' />
            ...
            <Link href='/raster' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='raster' src='/images/home/raster.png' />
            ...
            <Link href='/moon' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='moon' src='/images/home/moon.png' />
            ...
            <Link href='/geojson' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='geojson' src='/images/home/geojson.png' />
            ...
            <Link href='/invert' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='invert' src='/images/home/invert.png' />
            ...
            <Link href='/heatmap' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='heatmap' src='/images/home/heatmap.png' />
            ...
            <Link href='/points' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='points' src='/images/home/points.png' />
            ...
            <Link href='/range' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='range' src='/images/home/range.png' />
            ...
            <Link href='/interact' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='interactive' src='/images/home/interact.png' />
            ...
            <Link href='/land' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='land' src='/images/home/land.png' />
            ...
            <Link href='/tissots' passHref>
              <div className={styles.linkContainer}>
                <Image width={640} height={363} alt='tissots' src='/images/home/tissots.png' />
