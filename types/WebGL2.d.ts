...
// declare const WebGLTimerQueryEXT: {
...
// declare const EXT_disjoint_timer_query: {
...
interface WebGL2RenderingContext extends WebGLRenderingContext {
  ...
  readPixels: ((x: number, y: number, width: number, height: number, format: number, type: number, offset?: number) => void) & ((x: number, y: number, width: number, height: number, format: number, type: number, dstData: ArrayBufferView | ArrayBuffer, dstOffset?: number) => void)
  ...
  texImage2D: ((target: number, level: number, internalformat: number, width: number, height: number, border: number, format: number, type: number, source: null | ArrayBufferView | ImageData | ImageBitmap | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement) => void) &
  ((target: number, level: number, internalformat: number, width: number, height: number, border: number, format: number, type: number, srcData: ArrayBufferView, srcOffset?: number) => void) &
  ((target: number, level: number, internalformat: number, format: number, type: number, image: null | ArrayBufferView | ImageBitmap) => void)

  texImage3D: ((target: number, level: number, internalformat: number, width: number, height: number, depth: number, border: number, format: number, type: number, offset: number) => void) & ((target: number, level: number, internalformat: number, width: number, height: number, depth: number, border: number, format: number, type: number, source: ImageData | ImageBitmap | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement) => void) & ((target: number, level: number, internalformat: number, width: number, height: number, depth: number, border: number, format: number, type: number, srcData?: ArrayBufferView) => void) & ((target: number, level: number, internalformat: number, width: number, height: number, depth: number, border: number, format: number, type: number, srcData: ArrayBufferView, srcOffset: number) => void)

  texSubImage2D: ((target: number, level: number, xoffset: number, yoffset: number, width: number, height: number, format: number, type: number, source: ImageBitmap | ImageData | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement) => void) & ((target: number, level: number, xoffset: number, yoffset: number, width: number, height: number, format: number, type: number, srcData: ArrayBufferView, srcOffset: number) => void)

  texSubImage3D: ((target: number, level: number, xoffset: number, yoffset: number, zoffset: number, width: number, height: number, depth: number, format: number, type: number, srcData?: ArrayBufferView, srcOffset?: number) => void) & ((target: number, level: number, xoffset: number, yoffset: number, zoffset: number, width: number, height: number, depth: number, format: number, type: number, pixels?: ImageData | ImageBitmap | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement) => void) & ((target: number, level: number, xoffset: number, yoffset: number, zoffset: number, width: number, height: number, depth: number, format: number, type: number, offset: number) => void)
  ...
  compressedTexImage2D: ((target: number, level: number, internalformat: number, width: number, height: number, border: number, imageSize: number, offset: number) => void) & ((target: number, level: number, internalformat: number, width: number, height: number, border: number, srcData: ArrayBufferView, srcOffset?: number, srcLengthOverride?: number) => void)
  compressedTexImage3D: ((target: number, level: number, internalformat: number, width: number, height: number, depth: number, border: number, offset: number) => void) & ((target: number, level: number, internalformat: number, width: number, height: number, depth: number, border: number, srcData: ArrayBufferView, srcOffset?: number, srcLengthOverride?: number) => void)

  compressedTexSubImage2D: ((target: number, level: number, xoffset: number, yoffset: number, width: number, height: number, format: number, imageSize: number, offset: number) => void) & ((target: number, level: number, xoffset: number, yoffset: number, width: number, height: number, format: number, srcData: ArrayBufferView, srcOffset?: number, srcLengthOverride?: number) => void)
  compressedTexSubImage3D: ((target: number, level: number, xoffset: number, yoffset: number, zoffset: number, width: number, height: number, depth: number, format: number, offset: number) => void) & ((target: number, level: number, xoffset: number, yoffset: number, zoffset: number, width: number, height: number, depth: number, format: number, srcData: ArrayBufferView, srcOffset?: number, srcLengthOverride?: number) => void)
  ...
  transformFeedbackVaryings: (program: WebGLProgram | null, constyings: string[], bufferMode: number) => void
