...
interface WebGL2RenderingContext extends WebGLRenderingContext {
  ...
  getBufferSubData: (
    ...
    dstData: ArrayBufferView | SharedArrayBuffer,
    dstOffset?: number,
    length?: number,
  ) => void;
  blitFramebuffer: (
  ...
  bufferData: (
    target: number,
    srcDataOrSize: number | ArrayBufferView | ArrayBuffer | SharedArrayBuffer,
    usage: number,
    srcOffset?: number,
    length?: number,
  ) => void;
  bufferSubData: (
    ...
    srcData: ArrayBufferView | ArrayBuffer | SharedArrayBuffer,
    srcOffset?: number,
    length?: number,
  ) => void;
  ...
  readPixels: ((
    ...
    ((
      ...
      format: number,
      type: number,
      dstData: ArrayBufferView | ArrayBuffer,
      dstOffset?: number,
    ) => void);
  ...
  texImage2D: ((
    ...
    ((
      ...
      format: number,
      type: number,
      image: null | ArrayBufferView | ImageBitmap,
    ) => void);
  ...
  texImage3D: ((
    ...
    ((
      ...
      format: number,
      type: number,
      source: ImageData | ImageBitmap | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement,
    ) => void) &
    ((
      target: number,
      level: number,
  ...
  texSubImage3D: ((
    ...
    ((
      ...
      format: number,
      type: number,
      pixels?: ImageData | ImageBitmap | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement,
    ) => void) &
    ((
      target: number,
      level: number,
  ...
  getActiveUniformBlockParameter: (
    ...
    pname: number,
  ) => Uint32Array | number | boolean | null;
