...
interface WebGLRenderingContext {
  ...
  bufferData: ((target: number, size: number, usage: number) => void) &
    ((target: number, data: ArrayBufferView, usage: number) => void) &
    ((target: number, data: ArrayBuffer, usage: number) => void);
  bufferSubData: ((target: number, offset: number, data: ArrayBufferView) => void) &
    ((target: number, offset: number, data: ArrayBuffer) => void);
  ...
  getFramebufferAttachmentParameter: (
    ...
    attachment: number,
    pname: number,
  ) => GLint | GLenum | WebGLRenderbuffer | WebGLTexture;
  ...
  texImage2D: ((
    ...
    format: number,
    type: number,
    pixels: null | ArrayBufferView | ImageBitmap,
  ) => void) &
    ((
      target: number,
      level: number,
  ...
  uniform1fv: ((location: WebGLUniformLocation, v: Float32Array) => void) &
    ((location: WebGLUniformLocation, v: number[]) => void);
  ...
  uniformMatrix2fv: ((
    ...
    ((location: WebGLUniformLocation, transpose: boolean, value: number[]) => void);
  uniformMatrix3fv: ((
    location: WebGLUniformLocation,
    transpose: boolean,
    value: Float32Array,
  ...
  /* PLUGINS */
  getExtension: ((name: 'OES_element_index_uint') => OES_element_index_uint) &
