...
export default class MapWorker implements Worker {
  ...
  onMessage ({ data }) {
    ...
    else if (type === 'updateCompass') this.map.updateCompass(data.bearing)
    else if (type === 'mouseupCompass') this.map.mouseupCompass()
    else if (type === 'resetCompass') this.map.resetCompass()
