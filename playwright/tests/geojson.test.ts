...
//   await expect(page).toHaveScreenshot('s2-geojson.png', { timeout: 2_000 })
// })
...
//   await page.waitForFunction(() => window.testMap !== undefined, { timeout: 7_000 })
//   await page.evaluate(waitMap)
//   await expect(page).toHaveScreenshot('s2-geojson-webgl.png', { timeout: 2_000 })
// })
...
//   await page.waitForFunction(() => window.testMap !== undefined, { timeout: 7_000 })
//   await page.evaluate(waitMap)
//   await expect(page).toHaveScreenshot('s2-geojson-webgl2.png', { timeout: 2_000 })
// })
...
//   await expect(page).toHaveScreenshot('s2-geojson-webgpu.png', { timeout: 2_000 })
// })
